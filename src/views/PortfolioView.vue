    ...
    return {
      ...
      items: [
        ...
        },
        {
          ...
          name: 'Todo App',
          imageUrl: 'sp2se',
          status: 'A task management application that helps users organize and prioritize their daily activities effectively.',
          tech: 'Spring Boot, React, Tailwind, MongoDB',
          github: 'null',
          demo: 'https://todo-x-sooty.vercel.app/'
        },
        {
          id: 5,
          name: 'Social Media',
      ...
      workItems: [
        {
          id: 1,
          name: 'Atom Solutions - Backend Developer',
          duration: 'May 2024 – Sep 2025',
          tech: 'Java, Python, React, HTML/CSS, PostgreSQL, JSON/CSV, Celery, Kafka, Docker, Rancher, GitLab CI/CD, Microservices.',
          companyLogo: 'https://atomsolution.vn/_next/static/media/ic_logo_2.76f61d15.svg', // file logo: /img/work-abc-logo.png
          github: 'null',
          demo: 'null'
        },
        {
      ...
      <header>
        <div
          ...
          <h4 class="text-base font-normal text-transparent bg-clip-text bg-gradient-to-r from-slate-100 to-amber-300">
            Real-world job experience & contributions</h4>
        </div>
      </header>
        ...
        <div
          ...
          <div v-for="item in workItems" :key="item.id">
            <div
              ...
              <!-- Company Logo -->
              <div class="flex h-12 w-12 items-center justify-center zoom-in">
                <img alt="Company Logo" loading="lazy" decoding="async" data-nimg="1"
                  class="drop-shadow-xl rounded rounded-xl" :src="item.companyLogo">
              </div>

              <!-- Job Info -->
              <div class="w-full flex flex-col gap-2 items-center text-sm md:text-base lg:text-lg">
                <div class="title-text font-medium text-secondary text-center">
                  {{ item.name }}
                </div>
                <div class="text-xs text-[#c1c1c1] text-center">
                  {{ item.duration }}
                </div>
                <div class="w-full mt-4 text-sm text-left text-amber-200">
                  {{ item.tech }}
                </div>
              </div>
            </div>
